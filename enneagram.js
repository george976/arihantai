...
async function enneagramdetails(discussion) {

const printdetails=({is_enneagram})=>{
  console.log(is_enneagram);
  return {is_enneagram}
  }
  try {
            ...
            parameters:{
              ...
              properties:{
                is_enneagram:{
                  "type": "boolean",
                    "enum": [true, false],
                    "description": "indicates whether the user specifically wants to take an enneagram test"
                },
                // is_products_list: {
                //     "type": "boolean",
                //     "enum": [true, false],
...
module.exports= {enneagramdetails}